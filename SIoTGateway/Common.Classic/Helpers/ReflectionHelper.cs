...
#if WINDOWS_UWP
        public static string GetNamedPropertyValue(ExpandoObject expandoObject, string dEVICE_ID_COLUMN_NAME, bool v1, bool v2)
        {
            throw new NotImplementedException();
        }

        public static Func<DeviceProperties, dynamic> ProducePropertyValueExtractor(string columnName, bool v1, bool v2)
        {
            throw new NotImplementedException();
        }
#endif
